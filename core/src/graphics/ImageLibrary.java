...
public class ImageLibrary
{
	...
	public void loadImages()
	{
		...
		try
		{
			...
			images.put("rustySword", new TextureRegion(new Texture("res/items/weapons/rustySword.png"), 0, 0, 1.0f, 1.0f));
			images.put("legendarySword", new TextureRegion(new Texture("res/items/weapons/legendarySword.png"), 0, 0, 1.0f, 1.0f));
			...
			animations.put("attacking", new Animation("res/character/rustySword/rustySwordAttackAnim.png", 10, 10, false));

			animationSet.put("rustySword", animations);

			animations = new HashMap<String, Animation>();
			animations.put("default", new Animation("res/character/legendarySword/legendarySwordIdleAnim.png", 50, 20, true));
			animations.put("attacking", new Animation("res/character/legendarySword/legendarySwordAttackAnim.png", 10, 20, false));
